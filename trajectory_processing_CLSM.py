...
def trajectory_processing(folder):
    ...
    ndvi_folder = os.path.join(
        '/rcfs/scratch/corn062/CLMS/bio-geophysical/vegetation_indices/ndvi_global_300m_10daily_v3')
    fnames = np.zeros(0, dtype=str)
    ...
    lai_folder = os.path.join(
        '/rcfs/scratch/corn062/CLMS/bio-geophysical/vegetation_properties/lai_global_300m_10daily_v2')
    fnames = np.zeros(0, dtype=str)
    ...
    swi_folder = os.path.join(
        '/rcfs/scratch/corn062/CLMS/bio-geophysical/soil_water_index/swi_global_12.5km_10daily_v4')
    fnames = np.zeros(0, dtype=str)
